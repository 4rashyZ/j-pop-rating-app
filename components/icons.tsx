...
export function MusicIcon({ size = 22 }: IconProps) {
  return <svg viewBox="0 0 24 24" width={size} height={size} aria-hidden="true"><path d="M9 18V6l11-2v12M9 9l11-2" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /><circle cx="6" cy="18" r="3" fill="none" stroke="currentColor" strokeWidth="1.8" /><circle cx="17" cy="16" r="3" fill="none" stroke="currentColor" strokeWidth="1.8" /></svg>;
}
